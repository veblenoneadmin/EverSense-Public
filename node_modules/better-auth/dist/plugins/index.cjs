...
const organization = require('../shared/better-auth.BBL-iB6G.cjs');
...
const admin = require('../shared/better-auth.BVaTxNzZ.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.AEdHzBYL.cjs');
const plugins_captcha_index = require('./captcha/index.cjs');
const plugins_oneTimeToken_index = require('../shared/better-auth.B0iWTKws.cjs');
